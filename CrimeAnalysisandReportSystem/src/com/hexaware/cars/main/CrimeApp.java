...
import com.hexaware.cars.dao.*;
import com.hexaware.cars.entity.*;
import com.hexaware.cars.exception.*;
import com.hexaware.cars.service.*;
...
public class CrimeApp {
    ...
    public static void main(String[] args) {
        try (Connection connection = DatabaseConnection.getConnection();
            ...
            while (running) {
                ...
                // Menu options with numbering
                System.out.println("\n\t\t1. OverALL Incidents");
                System.out.println("\t\t2. OverAll Victims");
                System.out.println("\t\t3. OverAll Suspects");
                System.out.println("\t\t4. OverAll Agencies");
                System.out.println("\t\t5. OverAll Officers");
                System.out.println("\t\t6. OverAll Evidence");
                System.out.println("\t\t7. OverAll Reports");
                System.out.println("\t\t8. OverAll Cases");
    ...
    private static void manageIncidents(Scanner scanner, IncidentDao incidentDao) {
        ...
        while (running) {
            System.out.println("\n--- Incident Management ---");
            System.out.println("---------------------------------");
            System.out.println("1. To Create Incident");
            ...
            System.out.println("7. Go to OverAll");
            System.out.print("Choose an option: ");
 ...
 // Victim Management
    private static void manageVictims(Scanner scanner, VictimDao victimDao) {
        ...
        while (running) {
            System.out.println("\n--- Victim Management ---");
            System.out.println("---------------------------------");
            System.out.println("1. To Create Victim");
            ...
            System.out.println("6.Go to OverAll");
            System.out.print("Choose an option: ");
 ...
 // Suspect Management
    private static void manageSuspects(Scanner scanner, SuspectDao suspectDao) {
        ...
        while (running) {
            System.out.println("\n--- Suspect Management ---");
            System.out.println("---------------------------------");
            System.out.println("1.To Create Suspect");
    ...
    private static void manageAgencies(Scanner scanner, AgencyDao agencyDao) {
        ...
        while (running) {
            System.out.println("\n--- Agency Management ---");
            System.out.println("---------------------------------");
            System.out.println("1. To Create Agency");
 ...
 // Officer Management
    private static void manageOfficers(Scanner scanner, OfficerDao officerDao) {
        ...
        while (running) {
            System.out.println("\n--- Officer Management ---");
            System.out.println("---------------------------------");
            System.out.println("1.To Create Officer");
...
// Evidence Management
    private static void manageEvidence(Scanner scanner, EvidenceDao evidenceDao) {
        ...
        while (running) {
            System.out.println("\n--- Evidence Management ---");
            System.out.println("---------------------------------");
            System.out.println("1. To Create Evidence");
 ...
 // Report Management
    private static void manageReports(Scanner scanner, ReportDao reportDao) {
        ...
        while (running) {
            System.out.println("\n--- Report Management ---");
            System.out.println("---------------------------------");
            System.out.println("1.To Create Report");
    ...
    private static void createReport(Scanner scanner, ReportDao reportDao) {
        ...
        System.out.print("Enter status (DRAFT / FINALIZED / OPEN / CLOSED): ");
        ...
        try {
            ...
            ReportStatus status = ReportStatus.valueOf(reportStatus.toUpperCase().trim().replace(" ", "_"));
...
//    Case Management
    private static void manageCases(Scanner scanner, CaseDao caseDao, IncidentDao incidentDao) {
        ...
        while (!back) {
            System.out.println("\n--- Case Management ---");
            System.out.println("---------------------------------");
            System.out.println("1.To Create Case");
