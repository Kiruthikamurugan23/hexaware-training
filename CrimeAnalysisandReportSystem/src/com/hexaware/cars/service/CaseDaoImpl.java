...
import com.hexaware.cars.dao.CaseDao;
...
public class CaseDaoImpl implements CaseDao {
	...
	@Override
	public Case createCase(String caseDescription, String caseStatus, int assignedOfficerId, List<Incident> incidents)
		...
		try (PreparedStatement stmt = connection.prepareStatement(query)) {
			...
			while (rs.next()) {
				Incident incident = new Incident(rs.getInt("IncidentID"), rs.getString("IncidentType"),
						rs.getTimestamp("IncidentDate"), rs.getBigDecimal("Latitude"), rs.getBigDecimal("Longitude"),
